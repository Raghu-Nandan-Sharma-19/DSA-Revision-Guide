  ...
  return (
    <div className="container mx-auto px-4">
      <div className="flex flex-col px-2 justify-center mt-16 lg:items-center">
        <h1 className="font-bold md:mt-8 md:text-4xl text-3xl text-center lg:text-5xl">SIMPLE NO-TRICKS PRICING</h1>
      ...
      <div className="mt-10 md:mt-16 rounded-3xl px-5 border-black lg:max-w-3xl lg:mx-auto lg:border-2 lg:p-10">
      ...
      <div className="mt-9 flex flex-col rounded-3xl px-6 md:items-center border-black lg:max-w-3xl lg:mx-auto lg:border-2 lg:p-10">
        <h1 className="px-3 font-bold text-green-600 md:px-32 md:text-xl font-serif lg:text-2xl">What's included</h1>
        ...
        <div className="mt-12 flex flex-col items-center justify-center lg:mt-16">
          <h1 className="font-bold text-center text-xl text-gray-600 lg:text-2xl">Less than a cup of coffee</h1>
          <div className="flex justify-center mt-3 flex-row gap-2">
            ...
            <h1 className="line-through text-center text-4xl font-extrabold font-sans mt-1 text-gray-400 lg:text-5xl lg:mt-2">$1000</h1>
          </div>
          <a
            href="#"
